...
import { Calendar, Clock, BookOpen, CheckCircle, AlertTriangle, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-400 font-bold">No hay eventos para este periodo</p>
                        </div>
                    ) : (
                                                ...
                                                <div className="flex items-start justify-between gap-3">
                                                    ...
                                                    <div className="flex items-center gap-2 shrink-0">
                                                        {event.status === 'pendiente' && (
                                                            <button
                                                                onClick={() => handleStatusChange(event.event_id, 'completado')}
                                                        ...
                                                        {event.status === 'completado' && (
                                                            <button
                                                                onClick={() => handleStatusChange(event.event_id, 'pendiente')}
